...
export default function AccountsPage() {
  ...
  const { data: recentTransactions, isLoading: transactionsLoading } =
    useRecentAccountTransactions(isAuthenticated);
  const deleteAccountMutation = useDeleteAccount();

  const isLoading =
    authLoading || accountsLoading || summaryLoading || transactionsLoading;
  ...
  return (
    <div className="space-y-8 p-6 bg-white dark:bg-[#25343b] min-h-screen transition-colors duration-200">
      ...
      {/* Resumo das Contas */}
      <AccountSummary summary={accountSummary?.summary} isLoading={isLoading} />
