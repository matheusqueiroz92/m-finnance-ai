        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl font-bold">
                R${" "}
                {insights?.potentialSavings?.toLocaleString("pt-BR", {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="col-span-1 md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Análise de padrões mensais</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="ghost"
          ...
          <Card className="col-span-1 md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Comparativo 2024/2025</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="ghost"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="col-span-1 md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Análise de portfolio</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="ghost"
          ...
          <Card className="col-span-1 md:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Retorno por categoria</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="ghost"
