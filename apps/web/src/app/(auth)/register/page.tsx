    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden md:flex md:w-1/2 bg-emerald-800 text-white p-10 flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <h2 className="text-3xl font-bold mb-4">Comece a controlar suas finanças hoje mesmo</h2>
          <p className="mb-6">Junte-se a milhares de pessoas que estão tomando controle das suas finanças com inteligência artificial.</p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Cadastre-se para começar a gerenciar suas finanças</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="text-sm text-gray-600 mt-4">
                ...
                <Link href="/termos" className="text-emerald-600 hover:text-emerald-800">
                  Termos de Serviço
                </Link>{' '}
                e{' '}
                <Link href="/privacidade" className="text-emerald-600 hover:text-emerald-800">
