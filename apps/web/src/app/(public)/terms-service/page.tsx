      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 space-y-6">
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            Ao acessar e usar o OFinanceAI, você aceita e concorda em estar
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed mb-3">
            O OFinanceAI é uma plataforma de gestão financeira pessoal que
            oferece:
          </p>
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            . Ao usar o OFinanceAI, você consente com nossa coleta e uso de
            informações pessoais conforme descrito em nossa política.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-zinc-200">
            <li>
              Você autoriza a cobrança recorrente em seu método de pagamento
            </li>
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            O OFinanceAI e todo o conteúdo, recursos e funcionalidades são
            propriedade da Anthropic e são protegidos por leis de direitos
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            O OFinanceAI não se responsabiliza por decisões financeiras tomadas
            com base nas informações fornecidas pelo serviço. As análises e
            recomendações são apenas para fins informativos e não constituem
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            momento. Notificaremos os usuários sobre mudanças significativas por
            email ou através do serviço. O uso continuado após as alterações
