...
export default function PrivacyPolicyPage() {
  return (
    <PageContainer
      ...
      subtitle="Última atualização: 15 de maio de 2025"
    >
      <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 space-y-6">
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            A OFinanceAI valoriza a privacidade de seus usuários. Esta Política
            de Privacidade explica como coletamos, usamos, compartilhamos e
            protegemos suas informações pessoais quando você usa nosso serviço.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-xl font-medium mb-2 mt-4 text-emerald-200">
          ...
          <ul className="list-disc pl-6 space-y-2 text-zinc-200">
            ...
            <li>
              Dados de contas bancárias e cartões (últimos dígitos apenas)
            </li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-zinc-200">
            ...
            <li>
              Com prestadores de serviços que nos ajudam a operar o serviço
            </li>
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            cumprir os propósitos descritos nesta política, a menos que a lei
            exija ou permita um período de retenção mais longo. Quando você
            exclui sua conta, removemos ou anonimizamos suas informações
            pessoais.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            intencionalmente informações de crianças. Se tomarmos conhecimento
            de que coletamos informações de uma criança, tomaremos medidas para
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            Notificaremos você sobre mudanças significativas enviando um email
            ou através de um aviso em nosso serviço. Recomendamos revisar esta
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            diferentes do Brasil. Quando isso ocorrer, garantiremos que existam
            salvaguardas adequadas para proteger suas informações conforme
            exigido pela LGPD.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-200 leading-relaxed">
            ...
            como tratamos suas informações, entre em contato conosco:
          </p>
