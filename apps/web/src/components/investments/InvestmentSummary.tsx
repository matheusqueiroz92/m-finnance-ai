...
export function InvestmentSummary({
  ...
  const returnIsPositive = summary?.totalReturn
      ...
      >
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              <p
                className={`text-sm font-medium ${isDark ? "text-emerald-300" : "text-gray-600"}`}
              >
                Valor Total
              </p>
              <h3
              ...
              <p
                className={`text-xs ${isDark ? "text-emerald-400" : "text-emerald-600"} mt-1 flex items-center`}
              >
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-xs ${returnIsPositive
                  ? isDark
                    ? "text-emerald-400"
                    : "text-emerald-600"
                  : isDark
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3
                className={`text-2xl font-bold mt-1 ${isDark ? "text-white" : "text-gray-900"}`}
              >
                {summary?.totalReturnPercentage?.toLocaleString("pt-BR", {
                  minimumFractionDigits: 2,
                  style: "currency",
                  currency: "BRL",
                }) || "R$ 0,00"}
