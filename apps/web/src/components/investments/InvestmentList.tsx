    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[...Array(4)].map((_, i) => (
          <Card
            key={i}
            className="animate-pulse bg-gray-200 dark:bg-gray-700 h-48"
          ></Card>
        ))}
      </div>
    );
  ...
  if (!investments || investments.length === 0) {
    return (
      <EmptyState
        ...
        icon={
          <TrendingUp
            className={`h-12 w-12 ${isDark ? "text-zinc-400" : "text-gray-400"}`}
          />
        }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {investments.map((investment) => (
        <Card
          key={investment._id}
          className={`overflow-hidden border shadow transition-colors duration-200 
                        ${
                          isDark
            ...
            <div className="p-6">
              <div className="flex justify-between items-start">
                <div className="flex items-center">
                  <div
                    className={`w-12 h-12 rounded-full ${getInvestmentTypeColor(investment.type)} 
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge
                        variant="outline"
                        className={`text-xs ${isDark ? "border-white/20 text-white" : ""}`}
                      >
                        {investment.ticker ||
                  ...
                  >
                    ...
                    <DropdownMenuItem
                      ...
                      className={`cursor-pointer text-red-600 dark:text-red-400 ${
                        isDark
                          ? "hover:bg-red-600/10 focus:bg-red-600/10"
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    R${" "}
                    {investment.investedValue.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                    })}
                  </p>
                </div>
              ...
              <div className="mt-4 flex justify-between items-center">
                <div>
                  ...
                  >
                    {investment.profitability >= 0 ? "+" : ""}
                    {investment.profitability.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                    })}
                    %
                  </p>
