      ...
      >
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <Receipt
              className={`h-12 w-12 mb-4 ${isDark ? "text-zinc-400" : "text-gray-400"}`}
            />
            <h3
        ...
        <Table>
          <TableHeader>
            ...
            >
              ...
              <TableHead
                className={`${isDark ? "text-zinc-400" : "text-gray-500"} text-right`}
              >
                Valor
              </TableHead>
              <TableHead
          ...
          <TableBody>
            {transactions.map((billing) => (
              ...
              >
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    ...
                    billing.status !== "paid" ? (
                      ...
                      <CalendarClock
                        className={`h-4 w-4 ${isDark ? "text-zinc-400" : "text-gray-500"}`}
                      />
                    )}
                    <span
                      className={isDark ? "text-zinc-300" : "text-gray-700"}
                ...
                <TableCell
                  className={`text-right font-medium ${isDark ? "text-white" : "text-gray-900"}`}
                >
                  R${" "}
