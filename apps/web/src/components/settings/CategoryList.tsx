    ...
    return (
      <div className="space-y-4">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className={`h-10 animate-pulse ${isDark ? "bg-gray-700" : "bg-gray-200"} rounded`}
          ></div>
        ))}
      </div>
    );
    ...
    <div>
      <Table>
        <TableHeader>
          <TableRow
            className={
              isDark ? "border-white/10 hover:bg-white/5" : "hover:bg-gray-100"
            }
          >
            <TableHead className={isDark ? "text-zinc-400" : "text-gray-500"}>
              Nome
            </TableHead>
            <TableHead className={isDark ? "text-zinc-400" : "text-gray-500"}>
              Tipo
            ...
            <TableHead
              className={`text-right ${isDark ? "text-zinc-400" : "text-gray-500"}`}
            >
              Ações
            </TableHead>
          </TableRow>
