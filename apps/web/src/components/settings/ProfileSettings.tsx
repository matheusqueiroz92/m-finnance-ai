      ...
      <div className="space-y-6">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div
              className={`border-t pt-4 ${isDark ? "border-white/10" : "border-gray-200"}`}
            >
              <h3
              ...
              <div
                className={`bg-emerald-50 border rounded-md p-4 mb-4 
                              ${
                                isDark
              ...
              <div
                className={`text-sm ${isDark ? "text-zinc-400" : "text-gray-500"}`}
              >
                Sua assinatura será renovada automaticamente. Você pode cancelar
                a qualquer momento.
              </div>
            </div>
          </div>
