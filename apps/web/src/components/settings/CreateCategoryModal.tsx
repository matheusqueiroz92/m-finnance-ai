      ...
      >
        ...
        <Form {...form}>
          ...
          >
            ...
            <div>
              <FormLabel className={isDark ? "text-zinc-300" : "text-gray-700"}>
                Ícone
              </FormLabel>
              <div
                className={`mt-2 grid grid-cols-10 gap-2 max-h-[160px] overflow-y-auto p-2 rounded-md ${
                  isDark
                    ? "bg-[#1a2329] border border-white/20"
