    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[...Array(4)].map((_, i) => (
          <Card
            key={i}
            className="animate-pulse bg-gray-200 dark:bg-gray-700 h-36"
          ></Card>
        ))}
      </div>
    );
        ...
        >
          <CardContent className="p-0">
            <div className="flex items-start">
              <div
                className={`${getAccountTypeColor(account.type)} p-6 flex items-center justify-center h-full`}
              >
              ...
              <div className="p-6 flex-1">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p
                      className={`font-bold text-xl mt-2 ${isDark ? "text-white" : "text-gray-900"}`}
                    >
                      R${" "}
                    ...
                    <p
                      className={`text-xs ${isDark ? "text-zinc-400" : "text-gray-500"} mt-1`}
                    >
