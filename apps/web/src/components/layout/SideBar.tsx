...
const navItems = [
  ...
  { icon: MessageCircle, label: "Consultor IA", href: "/consultant" },
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      <div
        className={`px-4 py-6 border-b transition-colors duration-200
                      ${isDark ? "border-white/10" : "border-emerald-700"}`}
      >
      ...
      >
        <div className="flex items-center space-x-3">
          <Avatar>
            ...
            <AvatarFallback
              className={`${isDark ? "bg-emerald-800 text-emerald-200" : "bg-emerald-700 text-white"}`}
            >
          ...
          <div>
            ...
            <p
              className={`text-xs ${isDark ? "text-emerald-300" : "text-emerald-100"}`}
            >
      ...
      <nav className="p-4 flex-1 flex flex-col">
        ...
        <div
          className={`pt-4 border-t transition-colors duration-200
                        ${isDark ? "border-emerald-700" : "border-emerald-700"
            }`}
        >
          <button
            onClick={logout}
