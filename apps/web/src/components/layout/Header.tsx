...
export default function Header() {
  ...
  const toggleSidebar = () => {
    ...
    document.dispatchEvent(
      new CustomEvent("toggle-sidebar", { detail: { isOpen: !isSidebarOpen } })
    );
  };

  return (
    <header
      className={`sticky top-0 z-30 w-full backdrop-blur-sm border-b px-4 md:px-6 py-3 transition-colors duration-200
                        ${
                          isDark
    ...
    >
      <div className="flex h-14 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            className={`relative ${isSearchOpen ? "w-64" : "w-9"} transition-all duration-300`}
          >
            {isSearchOpen ? (
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 py-2 h-9 rounded-2xl transition-colors duration-200
                              ${
                                isDark
