  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger className="focus:outline-none">
        <Avatar
          className={`h-9 w-9 border-2 cursor-pointer transition-colors duration-200
                      ${
                        isDark
      ...
      <DropdownMenuContent
        className={`w-56 mt-1 mr-1 border transition-colors duration-200 rounded-2xl
                    ${
                      isDark
      ...
      >
        <div className="flex items-center justify-start gap-2 p-2">
          <div
            className={`rounded-full h-8 w-8 flex items-center justify-center transition-colors duration-200
                        ${
                          isDark
          ...
          <div className="flex flex-col space-y-0.5 leading-none">
            <p
              className={`font-medium text-sm truncate max-w-[170px] transition-colors duration-200
                          ${isDark ? "text-white" : "text-gray-900"}`}
            >
              {user?.name}
            </p>
            <p
              className={`text-xs truncate max-w-[170px] transition-colors duration-200
