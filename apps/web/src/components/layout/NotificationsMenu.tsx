  ...
  const notifications = [
    {
      ...
      message: "Você recebeu uma nova transação de R$500,00",
      time: "Há 10 minutos",
      read: false,
    },
    {
      id: 2,
      title: "Meta atingida",
      message: 'Você atingiu 80% da sua meta de "Férias"',
      time: "Há 2 horas",
      read: true,
    },
    {
      ...
      message: "Você tem um pagamento agendado para amanhã",
      time: "Há 1 dia",
      read: true,
    },
  ];
    ...
    <TooltipProvider>
      <DropdownMenu>
        <Tooltip>
          ...
          <TooltipContent
            side="bottom"
            className={`text-xs ${isDark ? "bg-[#1a2329] border-white/10 text-white" : "bg-white border-gray-200 text-gray-800"}`}
          >
            <p>Notificações</p>
          </TooltipContent>
        </Tooltip>
        ...
        <DropdownMenuContent
          className={`w-80 mt-1 border transition-colors duration-200 rounded-2xl
                                         ${
                                           isDark
        ...
        >
          ...
          {notifications.length > 0 ? (
            <>
              ...
              />
              <DropdownMenuItem
                className={`cursor-pointer justify-center py-2 transition-colors duration-200
                                          ${
                                            isDark
            ...
            <div
              className={`py-4 text-center text-sm transition-colors duration-200
                            ${isDark ? "text-zinc-400" : "text-gray-500"}`}
            >
