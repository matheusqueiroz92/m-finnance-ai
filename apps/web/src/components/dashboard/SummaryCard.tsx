    ...
    >
      <CardContent className="pt-6">
        <div className="flex items-center justify-between">
          ...
          <div
            className={`w-10 h-10 rounded-full ${iconBackground} flex items-center justify-center transition-colors duration-200`}
          >
            <Icon
              className={`h-5 w-5 ${iconColor} transition-colors duration-200`}
            />
          </div>
        </div>
      </CardContent>
