    ...
    <LoadingOverlay isLoading={isLoading} message="Criando sua conta...">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormControl>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="bg-zinc-50 p-5 pl-10 rounded-2xl"
                      {...field}
                    />
                  </div>
                </FormControl>
                ...
                <FormControl>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="bg-zinc-50 p-5 pl-10 pr-10 rounded-2xl"
                      placeholder="•••••••••"
                      {...field}
                    />
                    <button
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      className="bg-zinc-50 p-5 rounded-2xl"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          <Button
            type="submit"
            className="w-full bg-emerald-600 hover:bg-emerald-300 text-[#25343b] p-5 mt-6 rounded-2xl"
            disabled={isLoading}
          >
