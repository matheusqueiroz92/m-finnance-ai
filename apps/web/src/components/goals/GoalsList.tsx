...
export function GoalsList({
  ...
  const getGoalIcon = (name: string, icon?: string) => {
    ...
    if (nameLower.includes("viagem") || nameLower.includes("férias")) {
      ...
      nameLower.includes("casa") ||
      nameLower.includes("apartamento")
    ) {
      return (
        <Home
      ...
      return (
        <Briefcase
          className={`h-5 w-5 ${isDark ? "text-orange-400" : "text-orange-500"}`}
        />
      );
    }
        ...
        >
          <CardContent className="p-0">
            <div className="p-6">
              ...
              <div
                className={`mt-4 text-sm ${isDark ? "text-zinc-400" : "text-gray-500"}`}
              >
