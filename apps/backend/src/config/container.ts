...
container.registerSingleton<IAIAnalysisService>(
  "AIAnalysisService",
  AIAnalysisService
);
...
container.registerSingleton<ICreditCardService>(
  "CreditCardService",
  CreditCardService
);
...
container.registerSingleton<IFinancialPlanningService>(
  "FinancialPlanningService",
  FinancialPlanningService
);
container.registerSingleton<IFinancialConsultantService>(
